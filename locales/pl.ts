export default {
  ...
  auth_email: 'E-mail',
  auth_password: 'Hasło',
  auth_display_name: 'Imię lub pseudonim',
  auth_sign_in: 'Zaloguj się',
  auth_sign_up: 'Utwórz konto',
  ...
  auth_continue_guest: 'Kontynuuj jako gość',
  auth_loading: 'Ładowanie…',
  auth_error_generic: 'Coś poszło nie tak. Spróbuj ponownie.',
  auth_error_title: 'Błąd',
  auth_validation_fields: 'Uzupełnij wszystkie pola',
  auth_validation_password_short: 'Hasło musi mieć co najmniej 8 znaków',
  auth_apple_unavailable: 'Logowanie przez Apple nie jest dostępne na tym urządzeniu',
  auth_placeholder_email: 'email@przykład.pl',
  auth_placeholder_name: 'Jan',
  auth_placeholder_password: 'min. 8 znaków',
  auth_ai_requires_login: 'Aby używać funkcji AI, zaloguj się na konto',
  auth_ai_requires_login_title: 'Wymagane logowanie',
  auth_sign_out: 'Wyloguj',
  auth_signed_in_as: 'Zalogowano',
  auth_guest: 'Gość (bez AI)',
} as const;
